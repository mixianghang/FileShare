...
//    			如果当队列中有多个消息0，只更新一次UI
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * »ñµÃÈ«¾Öcontext, ²¢±£Ö¤Ö»µ÷ÓÃÒ»´Î getApplicationContext()
         */
...
//        updateUi();
    ...
    protected void onStart() {
    	super.onStart();
//    	当有需要更新界面的操作发生时，通知此handler,此种模式不错
...
//处理对于statStopButton的点击，分别启动或关闭ftp服务器的后台service
//    修改：检测wifistate，当有wifi的时候，才会连接
