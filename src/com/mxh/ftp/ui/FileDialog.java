                ...
                createButton.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                                if (mFileName.getText().length() > 0) {
                                		String fileDir= mFileName.getText().toString();
//                                		if(!fileDir.matches("[_A-Za-z][_A-Za-z0-9]*")){
//                                			Util.makeToast(getApplicationContext(), "please input right dir name");
//                                			return;
//                                		}
                                		File file=new File(currentPath+"/"+fileDir);
                                		Log.e("fileDir", file.getAbsolutePath());
                                		if(file.exists()){
                                			Util.makeToast(getApplicationContext(), "file dir  already exists");
                                			return;
                                		}
                                		if(!file.mkdir()){
                                			Util.makeToast(getApplicationContext(), "exception when making the dir"+file.getAbsolutePath());
                                			return;
                                		}
...
//                        Util.makeToast(getApplicationContext(), "please choose a directory");
                	selectedFile = file;
                	getIntent().putExtra(RESULT_PATH, selectedFile.getPath());
                    setResult(RESULT_OK, getIntent());
                    finish();
